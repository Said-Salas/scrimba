...
print("Initiating Cryptography Toolkit v1.0...")
...
while True:
    ...
    if choice == "0":
        ...
        print("SHA Hash of file is ", hash_file(file_path))
    elif choice == "2":
        file_path1 = input("Enter path of file one: ")
        file_path2 = input("Enter path of file two: ")
